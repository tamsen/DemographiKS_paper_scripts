...
class TestKsByNb(unittest.TestCase):
    ...
    def test_Ks_for_varying_Nb_one_bottleneck_Na_fixed_at_100_auto(self):
        demographiKS_out_path = '/home/tamsen/Data/DemographiKS_output_from_mesx/KS_vs_Nb/Na100_auto'
        specks_out_path = '/home/tamsen/Data/Specks_output_from_mesx'
        ...
        run_list_name = "Ks_for_varying_Nb_constantRC8andNa100_auto"
        # since mutation rate is 1.0e-5
        # we multiply by 1/1.2 since thats syn / total mut rate
