...
def make_Tc_Ks_vs_truth_fig_with_subplots(bin_sizes_Ks, bin_sizes_Tc,
    ...
    for i in range(1, num_runs):
        ...
        dgx_hist_ys, bins=plot_ks(i,ax[0, i], config_used, demographiKS_ks_results, truth_ks_results,
